...
export const artistEvents: ArtistEvent[] = [
  ...
  { slug: "h-and-g3", title: "Horse & Groom", artist: "Dirty Funk Face", start: 20.5*60, duration: 30, image: "/artists/dirtyfunkface.jpg", shortDescription: "Two funky musical mates funking up originals and making funky covers funkier.", description: "Two funky musical mates funking up originals and making funky covers funkier.", locationId: "horse-groom", timelineGroupId: "horse-groom" },
...
export const timelineRows: TimelineRow[] = [
    ...
    { id: "red-rocket", title: "Information Point and records sell", start: 10*60, duration: 420, artistEventIds: ["red-rocket"] },
  ]},

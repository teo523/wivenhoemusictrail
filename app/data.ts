...
export const locations: Location[] = [
  ...
  { id: "red-rocket", name: "Red Rocket Music", address: "3, Jolliffe's Yard, 51 -57 High Street", mapsUrl: "https://maps.app.goo.gl/xZpuwUu9TA7b5rjp8", lat: 51.8564030771398, lng: 0.9589725085953011, approximate: true },
...
export const artistEvents: ArtistEvent[] = [
  ...
  { slug: "studio1", title: "Open Studio 1", artist: "Richard Haylock", start: 11*60, duration: 280, image: "/artists/rich.jpeg", shortDescription: "Rich shares his recording space and music work at 8 Sandford Close.", description: "Rich shares his recording space and music work at 8 Sandford Close", locationId: "sandford-8", timelineGroupId: "open-studios",artistOrder: 10 },
  ...
  { slug: "studio3", title: "Open Studio 3", artist: "Juanes Sanchez", start: 11*60, duration: 280, image: "/artists/juanes.jpeg", shortDescription: "Playing vinyl records on the driveway at 15 Claremont Road.", description: "Come and share with Juanes his vinyl records collection.", locationId: "claremont-15", timelineGroupId: "open-studios",artistOrder: 12 },
  { slug: "studio4", title: "Open Studio 4", artist: "Abigail Lovejoy", start: 11*60, duration: 280, image: "/artists/abbie.png", shortDescription: "Open Jam Session at the driveway in 56 Old Ferry Road", description: "Abigail & co. will be facilitating an open jam session, Come and join playing!", locationId: "old-ferry-56", timelineGroupId: "open-studios" ,artistOrder: 12},
  ...
  { slug: "red-rocket", title: "Red Rocket Music", artist: "Fiona Harmon", start: 11*60, duration: 360, image: "/artists/fiona.jpg", shortDescription: "Spinning and selling of vinyls at Red Rocket Music. Come here to collect your map and for general information about the Wivenhoe Music Trail.", description: "Fiona will be be spinning some vinyl at the Red Rocket Music store, which will be open throughout the day as an information point for the Music Trail. Also, she will have vinyl for sale, band tees, and so much more", locationId: "red-rocket", timelineGroupId: "red-rocket",artistOrder: 14 },
 
  { slug: "choir", title: "Millfields Primary Choir", artist: "Millfields Primary Choir", start: 11.5*60, duration: 30, image: "/artists/millfields.png", shortDescription: "Millfields Primary Choir.", description: "A joyful choir performance featuring a mix of contemporary and traditional repertoire by the Millfields Primary School Choir, directed by Natasha Bennett.", locationId: "st-marys", timelineGroupId: "choir" },
  ...
  { slug: "folk-duo", title: "Open Singing Workshop", artist: "Wivenhoe Youth Choir", start: 15*60, duration: 40, image: "/artists/wivyouthchoir.jpg", shortDescription: "Come and join singing along the Wivenhoe Youth Choir", description: "An open singing experience that invites everyone to join. No prior experience needed. ", locationId: "st-marys", timelineGroupId: "folk-duo" },
  { slug: "west-street2", title: "West Street Stage", artist: "The Glowsticks", start: 15*60, duration: 80, image: "/artists/glowsticks.jpg", shortDescription: "The Glowsticks in an open garden concert at 21 West Street.", description: "The Glowsticks in an open garden concert at 21 West Street.", locationId: "west-street-21", timelineGroupId: "west-street" },  
  { slug: "west-street1", title: "West Street Stage", artist: "The Good Badgers", start: 16.5*60, duration: 60, image: "/artists/goodbadgers.jpg", shortDescription: "The Good Badgers in an open garden concert at 21 West Street.", description: "The Good Badgers in an open garden concert at 21 West Street.", locationId: "west-street-21", timelineGroupId: "west-street" },
  { slug: "organ", title: "Organ concert", artist: "John Dowden", start: 16*60, duration: 30, image: "/artists/john.jpg", shortDescription: "Music from around the world and adapted to the beauty of organ's sound.", description: "John Dowden will play a number of short arrangements for the organ of attractive music lying between the traditional classical style and what is sometimes described as ‘easy listening’ but whose character in each case puts across clear ideas. The programme will start with Telstar, composed to mark one of the defining moments in the history of telecommunications, and ends with La Bamba, originally a wordless Mexican Wedding Dance believed to have African origins. The intermediate pieces all celebrate the wonder of the world we live in.", locationId: "st-marys", timelineGroupId: "choir" },
  { slug: "folk", title: "Folk Session", artist: "Aryn Clark", start: 15.5*60, duration: 120, image: "/artists/aryn.jpeg", shortDescription: "An acoustic folk session at The Black Buoy.", description: "Essex has a strong tradition of pub sessions, in which folk musicians get together and play or sing for one other and pub patrons. Please come along to the Black Buoy and enjoy this informal open session, either as a participant or an audience member. Facilitated by Aryn Clark", locationId: "black-buoy", timelineGroupId: "folk" },
  ...
  { slug: "songwriter-1", title: "Singers & Songwriters Stage", artist: "Megan Klabunde", start: 17*60, duration: 30, image: "/artists/meganklabunde.jpg", shortDescription: "From jazz classics to contemporary jazz.", description: "Megan will be singing jazz, ranging from modern jazz and jazz compositions of popular modern songs to the great american songbook classics.", locationId: "rose-crown", timelineGroupId: "songwriters", tbc: true },
  { slug: "songwriter-2", title: "Singers & Songwriters Stage", artist: "Sinead Orme", start: 17*60+30, duration: 30, image: "/artists/sinead.jpg", shortDescription: "Folk/acoustic songs that tell us stories.", description: "Sinéad Orme is an Irish singer-songwriter, born in Dublin and now based in Essex. Her music is a folk/acoustic style and she has a love for storytelling through her songs. She has recorded two studio albums and regularly performs live around Wivenhoe and Colchester, including the Colchester and Wivenhoe Folk Club, The Black Buoy and The Horse and Groom.  ", locationId: "rose-crown", timelineGroupId: "songwriters", tbc: true },
  { slug: "songwriter-3", title: "Singers & Songwriters Stage", artist: "Fuad Farooqi", start: 18*60, duration: 30, image: "/artists/fuad.jpeg", shortDescription: "Fuad Farooqi at the Rose and Crown", description: "Fuad Farooqi at the Rose and Crown", locationId: "rose-crown", timelineGroupId: "songwriters", tbc: true },
  { slug: "songwriter-4", title: "Singers & Songwriters Stage", artist: "Steve Munro", start: 18*60+30, duration: 30, image: "/artists/steve.jpg", shortDescription: "Original energetic indie-pop songs.", description: "One of five singers and songwriters performing by the quay at the Rose & Crown. Steve will be playing original energetic indie-pop songs.", locationId: "rose-crown", timelineGroupId: "songwriters", tbc: true },
  { slug: "songwriter-5", title: "Singers & Songwriters Stage", artist: "Simon Craze", start: 19*60, duration: 30, image: "/artists/simon.jpeg", shortDescription: "Tunes from Simon's new acoustic album 'Let Him Have It'.", description: "Simon just completed a three album series called ‘Input-Process-Output’ with his latest album ‘Let Him Have It’. His live shows are unplugged versions of his recorded material.", locationId: "rose-crown", timelineGroupId: "songwriters", tbc: true },

  { slug: "jetty1", title: "Sunset Supper 1", artist: "Hannah Price and Margaret Miller", start: 18*60, duration: 60, image: "/artists/jetty.jpeg", shortDescription: "Violin duets from Mozart to Broadway.", description: "Hannah and Margaret started playing violin duets together last year and enjoy exploring different kinds of music and just having fun. They loved the idea of a Wivenhoe Music Trail because they believe everyone can have a go at making music. They have put together a short programme including Mozart duos and songs from Broadway shows and films.", locationId: "jetty", timelineGroupId: "jetty" },
  { slug: "jetty2", title: "Sunset Supper 2", artist: "Adam Jones", start: 19*60, duration: 60, image: "/artists/adam.jpg", shortDescription: "Traditional Spanish/South American classical guitar.", description: "Adam Jones is an Essex and Suffolk guitarist who will be bringing a broad repertoire of traditional Spanish and South American classical guitar.", locationId: "jetty", timelineGroupId: "jetty" },
  ...
  { slug: "h-and-g1", title: "Horse & Groom", artist: "Didge & Sticks", start: 19*60, duration: 30, image: "/artists/didge.png", shortDescription: "An irruption of percussive grooves from the didgeridoo and drum duo 'Didge & Sticks'", description: "An irruption of percussive grooves from the didgeridoo and drum duo 'Didge & Sticks'", locationId: "horse-groom", timelineGroupId: "horse-groom" },
  { slug: "h-and-g2", title: "Horse & Groom", artist: "If Not Now", start: 19.75*60, duration: 30, image: "/artists/ifnotnow.jpeg", shortDescription: "Alternative female-fronted rock band.", description: "If Not Now are an Essex-based, female-fronted rock band. Their music explores parenthood, sadness, fury and escapism, blending everyday struggles and emotions into introspective, angst-ridden alternative rock.", locationId: "horse-groom", timelineGroupId: "horse-groom" },
  { slug: "h-and-g3", title: "Horse & Groom", artist: "Dirty Funk Face", start: 20.5*60, duration: 30, image: "/artists/dirtyfunkface.jpg", shortDescription: "Four different bands will wrap up the evening at the H&G.", description: "Four different bands will wrap up the evening at the H&G.", locationId: "horse-groom", timelineGroupId: "horse-groom" },
...
export const timelineRows: TimelineRow[] = [
    { name: "Red Rocket Music", color: "bg-blue-500", events: [
    { id: "red-rocket", title: "Information Point and records sell", start: 11*60, duration: 360, artistEventIds: ["red-rocket"] },
  ]},
  ...
  { name: "St Mary's Church Yard", color: "bg-blue-500", events: [
    ...
    { id: "folk-duo", title: "Wivenhoe Youth Choir", start: 14.75*60, duration: 40, artistEventIds: ["folk-duo"] },
    { id: "organ", title: "Organ concert", start: 16*60, duration: 30, artistEventIds: ["organ"] },

...
export const artistEvents: ArtistEvent[] = [
  ...
  { slug: "west-street2", title: "West Street Stage", artist: "The Glowsticks", start: 16.5*60, duration: 60, image: "/artists/poetry-jam.svg", shortDescription: "The Glowsticks in an open garden concert at 21 West Street.", description: "The Glowsticks in an open garden concert at 21 West Street.", locationId: "west-street-21", timelineGroupId: "west-street" },

  { slug: "folk", title: "Folk Session", artist: "Various Artists", start: 15.5*60, duration: 120, image: "/artists/aryn.jpeg", shortDescription: "An acoustic folk session at The Black Buoy.", description: "An acoustic performance by a group of folk makers. Facilitated by Aryn Clarke", locationId: "black-buoy", timelineGroupId: "folk" },

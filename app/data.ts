    ...
    events: [
      {
        ...
        address: "The Old Manse, 40 High Street",
        mapsUrl: "https://maps.app.goo.gl/uMM61wUiwwnbAeF17"
      },
    ],
  },
  {
    ...
    events: [
      {
        ...
        start: 17 * 60,
        duration: 150,
        image: "/artists/roseandcrown.jpg",
    ...
    events: [
      {
        ...
        start: 19 * 60,
        duration: 120,
        image: "/artists/station.png",
        shortDescription: "Power folk from Poland ",
        description: "Somethingski Trio is a musical project by Nikodem Soszyński, known from Freeborn Brothers. The band debuted in 2020 with the album THINGS, featuring the hit Na Dolinach, which topped the Podkarpacka Hit List. Their music spans folk, rock, and 1970s-inspired pop",
        address: "Station Pub",
    ...
    events: [
      {
        ...
        start: 20 * 60,
        duration: 120,
        image: "/artists/horseandgroom.jpg",

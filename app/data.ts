...
export const artistEvents: ArtistEvent[] = [
  ...
  { slug: "folk", title: "Folk Session", artist: "Aryn Clarke", start: 15.5*60, duration: 120, image: "/artists/aryn.jpeg", shortDescription: "An acoustic folk session at The Black Buoy.", description: "Essex has a strong tradition of pub sessions, in which folk musicians get together and play or sing for one other and pub patrons. Please come along to the Black Buoy and enjoy this informal open session, either as a participant or an audience member. Facilitated by Aryn Clarke", locationId: "black-buoy", timelineGroupId: "folk" },
